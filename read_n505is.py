...
parser.add_argument(
    "-c",
    "--config",
    help="Choose configuration. Accepted values: N505i, N505iS",
    default="N505iS",
    type=str,
)
...
for i in range(LIST_START, LIST_END, 8):
    if (
        ...
        if not ext:
            ...
            if file_data[:4] == b"melo":
                ...
                ext = "swf"
            elif file_data[:12] in [
                b"\x00\x00\x00\x1cftypn5lm",
                b"\x00\x00\x00\x1cftypn5mv",
            ]:
                ext = "3gp"
                ...
                b"<HTML>" in file_data
                and b"</HTML>" in file_data
                or b"<html>" in file_data
                and b"</html>" in file_data
            ):
                ext = "html"
